...
<section class="messages">
   ...
   <?php
      $select_message = mysqli_query($conn, "SELECT * FROM `feedback` ORDER BY feedback_date DESC") or die('query failed');
   ...
   <div class="box">
      ...
      <p> date : <span><?php echo $fetch_message['feedback_date']; ?></span> </p>
      <p> message : <span><?php echo $fetch_message['description']; ?></span> </p>
