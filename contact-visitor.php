...
<?php
    ...
    if(isset($_POST['send_btn']))
    {
        ...
        mysqli_query($conn, "INSERT INTO `feedback`(email, description, feedback_date, number, name) VALUES('$email','$msg','$date','$number','$name')") or die("failed");
...
<body>
    ...
    <div class="heading">
        <h3>contact us</h3>
        <p><a href="home-visitor.php">home</a> / contact </p>
    </div>
