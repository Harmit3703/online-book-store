   ...
   if(isset($_POST['submit']))
               {
                  ...
                  if(mysqli_num_rows($select_user)==1)
                  {
                     ...
                     header('location:admin_otp_pass_verify.php');
                  }else{
                     echo '<p style="font-size: 20px;position: absolute;top: 50%;left: 40%;">this user does not exists...!</p>';
                  }
...
<body>
    ...
    <form action="admin_forgot_pass.php" method="post">
           <h3>admin password recovery</h3>
           <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Enter your email" required class="box">
